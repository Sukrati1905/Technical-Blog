...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" onclick="getPost(0,<%= user.getId()%>, this)" href="my_posts.jsp">My Posts</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="list-group">
                            ...
                            <a href="#" class="posting-status list-group-item list-group-item-action">
                                Your Posting Status
                            </a>
                            ...
                            %>
                            <a href="#" onclick="getPost(<%= ele.getCid()%>, <%= user.getId()%>, this)" class="c-link list-group-item list-group-item-action"><%= ele.getName()%></a>
                            <%
                                }
                    ...
                    <div class="col-md-8">
                        ...
                        <div id="status" class="container-fluid my-4">
                            <div class="row">
                                <div class="col-md-12 text-center text-muted" >
                                    <p style="font-size: 30px; ">Number of posts</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 text-center text-muted" >
                                    <p style="font-size: 70px; font-weight: bold "><%= pd.getPostCountByUserId(user.getId())%></p>
                                </div>
                            </div>
        ...
        <!--loading posts-->
        <script>
            function getPost(cid, uid, temp) {
                $("#loader").show();
                $("#post_container").hide();
                $(".c-link").removeClass("active list-group-item-success");
                $(".posting-status").removeClass("active list-group-item-success");
            ...
            $(document).ready(function () {
                ...
                $("#post_container").hide();
                $("#loader").hide();
                $(".posting-status").addClass("active list-group-item-success");

                $(".posting-status").click(function () {
                        $(".posting-status").addClass("active list-group-item-success");
                        $("#post_container").hide();
                        $("#loader").hide();
                        $(".c-link").removeClass("active list-group-item-success");
